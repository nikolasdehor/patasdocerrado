...
<head>
    ...
    <link rel="icon" href="imagens/paw.svg" type="image/svg+xml">
    ...
    <style>
        ...
        .hero {
            background-image: url('imagens/dog.jpg');
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-primary" href="login.html">Login/Registrar</a>
                    </li>
                </ul>
            </div>
        </nav>
                    ...
                    <div class="col-md-4">
                        <div class="card pet-card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="adopt.html?pet=rex" class="btn btn-primary">Mais Informações</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card pet-card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="adopt.html?pet=luna" class="btn btn-primary">Mais Informações</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card pet-card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="adopt.html?pet=bobby" class="btn btn-primary">Mais Informações</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        const setFavicon = (theme) => {
            ...
            if (theme === 'dark') {
                favicon.href = 'imagens/paw-white.svg';
            } else {
                favicon.href = 'imagens/paw.svg';
            }
        };
